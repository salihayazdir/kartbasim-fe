...
type AddProductInventoryRecordDialogProps = {
  open: boolean;
  setOpen: React.Dispatch<React.SetStateAction<boolean>>;
};

export default function AddProductInventoryRecordDialog({
  open,
  setOpen,
}: React.PropsWithChildren<AddProductInventoryRecordDialogProps>) {
  ...
  return (
    <DialogWrapper open={open} setOpen={setOpen} title='Stok Hareketi Oluştur'>
