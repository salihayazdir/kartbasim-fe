...
type ConsumableTypeActionsDropdownProps = {
  record: ConsumableType;
  setEditConsumableTypeModalIsOpen: React.Dispatch<
    React.SetStateAction<boolean>
  >;
  setDeleteConsumableTypeModalIsOpen: React.Dispatch<
    React.SetStateAction<boolean>
  >;
...
export default function ConsumableTypeActionsDropdown({
  record,
  setEditConsumableTypeModalIsOpen,
  setDeleteConsumableTypeModalIsOpen,
  setSelectedRecord,
}: ConsumableTypeActionsDropdownProps) {
  return (
      ...
      <Menu.Items className='absolute z-10 flex -translate-x-[calc(100%-50px)] flex-col gap-1 rounded-lg border border-slate-200 bg-white p-2 text-xs shadow-lg'>
        ...
        <Menu.Item>
          <button
            onClick={() => {
              ...
              setEditConsumableTypeModalIsOpen(true);
            }}
        ...
        <Menu.Item>
          <button
            onClick={() => {
              setSelectedRecord(record);
              setDeleteConsumableTypeModalIsOpen(true);
            }}
