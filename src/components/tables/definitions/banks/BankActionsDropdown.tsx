...
export default function BankActionsDropdown({
  ...
  return (
    <Menu as={'div'} className=''>
      <Menu.Button className='relative items-center justify-center gap-1 rounded-md p-1 text-blue-600 transition-all hover:bg-blue-50'>
      ...
      <Menu.Items className='absolute z-10 mb-10 flex -translate-x-[calc(100%-50px)] flex-col gap-1 rounded-lg border border-slate-200 bg-white p-2 text-xs shadow-lg'>
        ...
        <Menu.Item>
          <button
            ...
            className='flex w-full items-center gap-3 rounded-md p-1 px-3 font-semibold text-slate-600 transition-all hover:bg-blue-50 hover:text-blue-700'
          >
        ...
        <Menu.Item>
          <button
            ...
            className='flex w-full items-center gap-3 rounded-md p-1 px-3 font-semibold text-slate-600 transition-all hover:bg-red-600 hover:text-white'
          >
